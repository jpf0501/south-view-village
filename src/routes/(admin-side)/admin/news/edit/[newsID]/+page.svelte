                ...
                <form action="">
                    ...
                    <div class="grid place-items-center my-10">
                        <div class="flex gap-5">
                            <button on:click={updateNews} type="submit" class="bg-blue-500 px-10 py-2">Submit</button>
                            <button on:click={deleteNews} type="submit" class="bg-red-500 px-10 py-2">Delete</button>
